...
EditorUi.prototype.initCanvas = function()
{
	...
	if (this.editor.isChromelessView())
	{
		...
		if (urlParams['toolbar'] != '0')
		{
			...
			this.chromelessToolbar.className = "viewToolbar";
			...
			graph.addMouseListener(
			{
			    ...
			    mouseUp: function(sender, me)
			    {
					...
					jsonObj = {"type": "graphMouseUp", "location": window.location, "MESSAGE_GRAPH_XML": xml, "MESSAGE_COMPRESSED": Graph.compress(xml), "event": serializeEvent(me.getEvent())};
